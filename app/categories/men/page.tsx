...
export default async function Men() {
  const perfumes = await getPerfumesByCategory("men");

  return (
    <main className="w-[90%] mx-auto py-10">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-bold tracking-widest">MEN</h1>
            ...
            <div key={perfume.id} className="group">
              ...
              <Link href={`/products/${perfume.id}`}>
                ...
                <div className="mt-3 space-y-1">
                  ...
                  <p className="text-sm text-gray-600">LE {perfume.price}.00 EGP</p>
                </div>
              </Link>
